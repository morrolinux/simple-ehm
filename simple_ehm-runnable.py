...
def generate_cut(ss, to, count):
    ...
    if (seconds > 10):
		## calculate a safe place for non accurate point 5 seconds before, then it takes an accurate point for ss. For speed porpouse
        safe = tmp - datetime.timedelta(seconds=5)
